...
<html lang="en">
    ...
    <body>
        <div class="navbar">
            <div class="titre">
                <a href="#" id="titre">MonSiteMarvel</a>
            </div>
            <a href="#" class="lien">
            ...
            <div href="#" class="lien conteneur">
                ...
                <ul class="conteneur_menu">
                    <a href="#" class="sous_lien">Comics</a>
                    <a href="#" class="sous_lien">Films</a>
                    <a href="#" class="sous_lien">Series</a>
                    <a href="#" class="sous_lien">Personnages</a>
                </ul>
            </div>
            <a href="#" class="lien">
